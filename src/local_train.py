...
class LocalUpdate(object):
	...
	def local_opt(self, optimizer, lr, epochs, global_model,is_phase1, momentum=0.5, mu=0.01, client_controls=[], 
		...
		if is_phase1==False:
			c=epochs
			lambda1=lambda epoch: ((c-epoch)*alpha1+epoch*alpha2)/c
		...
		return local_changes, control_changes, client_controls, epoch_loss[-1], len(self.train_loader),self.train_loader
