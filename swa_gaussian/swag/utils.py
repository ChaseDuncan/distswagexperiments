...
def dist_train_epoch(...):
  # Distribute this across workers
  # TODO:
  # 1. distribute training across workers
  # 2. Make sure that train_epoch works for an individual worker
  # 3. What does train_epoch return?
  # 4. Aggregate gradient or parameters
